...
# Python 3.13 / 3.11 Updater bug ကာကွယ်ရေး
import telegram.ext
...
# Logging setup (တစ်ခုတည်းပဲ ထားရပါမယ်)
...
# (ဒီအောက်ကနေ မင်းရဲ့ မူလကုဒ်တွေအတိုင်း ပုံမှန်အတိုင်း ဆက်သွားပါ...)
...
if __name__ == "__main__":
    ...
    # ⚠️ ဒီစာကြောင်းလေးကို မဖြစ်မနေ အောက်ဆုံးမှာ ထည့်ပေးရပါမယ်!
    app.run_polling()
