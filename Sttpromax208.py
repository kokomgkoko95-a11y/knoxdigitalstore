...
# Python 3.13 ရဲ့ Updater bug ကို အတင်းဝင်ပြင်တဲ့ သော့ချက် (အပေါ်ဆုံးမှာ ထားရပါမယ်)
import telegram.ext
if not hasattr(telegram.ext.Updater, '__dict__'):
    telegram.ext.Updater.__dict__ = {}

# ဒီအောက်ကနေ မင်းရဲ့ မူလ Import ကုဒ်တွေအတိုင်း ပုံမှန်အတိုင်း ပြန်စပါမယ်
import logging
import random
import html
import requests
...
# ============= CONFIG =============
# (ဒီအောက်ကနေ မင်းရဲ့ BOT_TOKEN, ADMIN_ID တွေအတိုင်း ဆက်သွားပါ...)
import logging
import random
import html
import requests
...
# ================= CONFIG =================
# နာမည်အသစ် ပြောင်းလိုက်ခြင်းဖြင့် ရေးလ်ဝေးက Variables အဟောင်းတွေကို ကျော်သွားလိမ့်မယ်
MY_NEW_TOKEN = "8563792607:AAEOSbDggmDbX2P-kY0sDUY7zY58hwlaBoU"
ADMIN_ID = 8263739354
...
async def buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ---------- MULTI-SELECT TIKTOK ORDER CONFIRM / REJECT ----------
        ...
        if action == "cfm":
            confirm_caption = (
                "❣️ လူကြီးမင်း၏ <b>{item_name}</b> ဝယ်ယူခြင်း အောင်မြင်ပါသည်။♥️\n\n"
                "❣️ ကြာချိန်ကတော့ ဝန်ဆောင်မှုအလိုက် စတင်လုပ်ဆောင်ပေးနေပါပြီ။💓\n\n"
                "❣️ Thank You So Much 🙏\n\n"
                "❣️ Owner - @just_knox\n\n"
                "❣️ နောက်အသစ်တစ်ခု ဝယ်ရန် /start ကိုနှိပ်ပါ"
...
async def photo_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if step == "tt_multi_payment":
        ...
        pending_caption = (
            ...
            "🤖 @knox_digital_store_bot ကို အသုံးပြုသည့်အတွက် ကျေးဇူးတင်ပါသည် 🎉\n\n"
...
if __name__ == "__main__":
    # ဒီနေရာမှာ အသစ်ပြောင်းထားတဲ့ နာမည်လေး ထည့်ပေးပါ
    app = ApplicationBuilder().token(MY_NEW_TOKEN).build()
