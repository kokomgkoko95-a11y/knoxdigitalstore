...
def ask_ai(user_text, conversation_history=None):
    ...
    system_prompt = (
        ...
        "📱 CapCut Pro, Canva Pro | ⭐ Telegram Premium & Accounts\n\n"
        "TikTok ဝန်ဆောင်မှုဈေးနှုန်း:\n"
        "❤️ Likes: 300=1,500ks | 500=2,000ks | 1k=4,000ks | 5k=19,000ks | 10k=38,000ks\n"
        "🍀 Views(ကျနိုင်): 1k=500ks | 3k=1,500ks | 5k=2,500ks | 10k=5,000ks | 100k=49,000ks\n"
        "🎵 Views(မကျ): 1k=1,000ks | 3k=2,500ks | 5k=4,500ks | 10k=9,000ks | 100k=85,000ks\n"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [
            InlineKeyboardButton("📦 Orderအခြေအနေ စစ်ရန်",   callback_data="order_status"),
