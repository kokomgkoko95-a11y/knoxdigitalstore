...
if __name__ == "__main__":
   import sys
if not hasattr(sys.modules['telegram.ext'].Updater, '__dict__'):
    sys.modules['telegram.ext'].Updater.__dict__ = {}

# အောက်က မင်းရဲ့ မူလကုဒ်အတိုင်း ဆက်ထားပါ
